...
export const ChangeDisplayName = ({ user }: { user: User | null }) => {
  return (
    <ChangeSettingDialog>
      <DialogHeader>
        <DialogTitle>Change your displayname</DialogTitle>
        <DialogDescription>Enter a new displayname.</DialogDescription>
      </DialogHeader>
